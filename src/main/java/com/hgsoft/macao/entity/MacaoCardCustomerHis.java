...
public class MacaoCardCustomerHis implements java.io.Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = 7436361088770478327L;
	...
	public MacaoCardCustomerHis(){
		
	}
	public MacaoCardCustomerHis(MacaoCardCustomer macaoCardCustomer,Date genTime,String genReason){
		this.address = macaoCardCustomer.getAddress();
		this.bankAccountNumber = macaoCardCustomer.getBankAccountNumber();
		this.bankCode = macaoCardCustomer.getBankCode();
		this.birDate = macaoCardCustomer.getBirDate();
		this.branchId  = macaoCardCustomer.getBranchId();
		this.cnName = macaoCardCustomer.getCnName();
		this.email = macaoCardCustomer.getEmail();
		this.enName = macaoCardCustomer.getEnName();
		this.genReason = genReason;
		this.genTime = genTime;
		this.hisSeqId = macaoCardCustomer.getHisSeqId();
		this.idCardNumber  =macaoCardCustomer.getIdCardNumber();
		this.idCardType = macaoCardCustomer.getIdCardType();
		this.invoiceTitle = macaoCardCustomer.getInvoiceTitle();
		this.reqOperId = macaoCardCustomer.getReqOperId();
		this.reqOperName = macaoCardCustomer.getReqOperName();
		this.reqOperNo = macaoCardCustomer.getReqOperNo();
		this.reqPlaceId = macaoCardCustomer.getReqPlaceId();
		this.reqPlaceName = macaoCardCustomer.getReqPlaceName();
		this.reqPlaceNo = macaoCardCustomer.getReqPlaceNo();
		this.reqTime = macaoCardCustomer.getReqTime();
		this.servicePwd = macaoCardCustomer.getServicePwd();
		this.sex = macaoCardCustomer.getSex();
		this.shortMsg = macaoCardCustomer.getShortMsg();
		this.state = macaoCardCustomer.getState();
		this.sureOperName = macaoCardCustomer.getSureOperName();
		this.surePlaceName = macaoCardCustomer.getSurePlaceName();
		this.sureTime = macaoCardCustomer.getSureTime();
		this.tel = macaoCardCustomer.getTel();
		this.userType = macaoCardCustomer.getUserType();
		
		this.reqSN = macaoCardCustomer.getReqSN();
		this.resSN = macaoCardCustomer.getResSN();
		this.resTime = macaoCardCustomer.getResTime();
		this.isNotify = macaoCardCustomer.getIsNotify();
		  /*YGZ RuiHaoZ Add 新增字段*/
		this.userNo = macaoCardCustomer.getUserNo();
		this.secondNo = macaoCardCustomer.getSecondNo();
		this.secondName = macaoCardCustomer.getSecondName();
		this.organTel = macaoCardCustomer.getOrganTel();
		this.agentName = macaoCardCustomer.getAgentName();
		this.agentTel = macaoCardCustomer.getAgentTel();
		this.agentIdType = macaoCardCustomer.getAgentIdType();
		this.agentIdCode = macaoCardCustomer.getAgentIdCode();
		this.writeSecond = macaoCardCustomer.getWriteSecond();
	}
	...
	public Long getMacaoCustomerId() {
		return macaoCustomerId;
	}
	public void setMacaoCustomerId(Long macaoCustomerId) {
		this.macaoCustomerId = macaoCustomerId;
	}
