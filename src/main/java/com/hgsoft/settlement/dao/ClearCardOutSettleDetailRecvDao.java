...
@Repository
public class ClearCardOutSettleDetailRecvDao extends ClearBaseDao {


    public List<Object[]> findAllObjsByBoardListNo(Long boardListNo) {
        final List<Object[]> cardOutSettleDetailObjs = new ArrayList<Object[]>();

        final String sql = "select " + CardOutSettleDetailRecv.TABLE_FIELD_NAMES +
                " from tb_cardoutsettledetail_recv WHERE boardlistno=?";
        ...
        super.query(sql, new RowCallbackHandler() {
            ...
            public void processRow(ResultSet resultSet) throws SQLException {
                ...
                cardOutSettleDetailObjs.add(objs);
            }
        }, new Object[]{boardListNo});

        return cardOutSettleDetailObjs;
        //return super.queryObjectList(sql, Object[].class);
    }
