 ...
 */
public class HandPaymentDetail implements Serializable {

    private static final long serialVersionUID = -6888830608760781502L;

    private Long id;
    private String baccount;
    private String cardNo;//详情表才有卡号
    private Long handPayMentId;//引用handPayment.id
	...
	public Long getHandPayMentId() {
		return handPayMentId;
	}

	public void setHandPayMentId(Long handPayMentId) {
		this.handPayMentId = handPayMentId;
	}
}
