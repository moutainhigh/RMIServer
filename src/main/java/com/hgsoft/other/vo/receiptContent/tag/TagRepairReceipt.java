 ...
 */
public class TagRepairReceipt extends BaseReceiptContent {
    /**
     * 标 签 号
     */
    ...
    public String getBackTagNo() {
        return backTagNo;
    }

    public void setBackTagNo(String backTagNo) {
        this.backTagNo = backTagNo;
    }
