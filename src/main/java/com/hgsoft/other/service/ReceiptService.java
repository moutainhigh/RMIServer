...
//							}
	...
	public Receipt findById_(Long id){
		return this.receiptDao.findById_(id);
	}
	...
	public Pager findReceiptsForACMS(Pager pager, Customer customer, String cardNo, Date startTime, Date endTime) {
		if (endTime != null) {
			Date newEndTime = new Date(endTime.getTime() + (24*60*60-1)*1000);
			endTime = newEndTime;
		} // if
		return receiptDao.findReceiptsForACMS(pager, customer, cardNo, startTime, endTime);
	}
