 ...
 */
public class TagMirateReceiptACMS extends BaseReceiptContent {
    /**
     * 标签号
     */
     ...
     * 原车辆用户类型
     */
    private String oldVehicleUserType;
    /**
     * 原使用性质
     */
    ...
    public String getOldVehicleUserType() {
        return oldVehicleUserType;
    }

    public void setOldVehicleUserType(String oldVehicleUserType) {
        this.oldVehicleUserType = oldVehicleUserType;
    }
