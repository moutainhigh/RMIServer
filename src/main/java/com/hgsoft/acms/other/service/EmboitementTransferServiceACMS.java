...
@Service
public class EmboitementTransferServiceACMS implements IEmboitementTransferService {
	
	private static Logger logger = Logger.getLogger(EmboitementTransferServiceACMS.class.getName());
	...
	public boolean saveTransfer(VehicleInfo vehicleInfo, Long customerId,
		...
		try {
			...
			serviceWater.setRemark("联营卡系统：套装过户");
