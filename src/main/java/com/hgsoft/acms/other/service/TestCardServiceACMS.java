...
@Repository
@Service
public class TestCardServiceACMS implements ITestCardService{
	private static Logger logger = Logger.getLogger(TestCardServiceACMS.class.getName());
...
//			}
	...
	public static void setLogger(Logger logger) {
		TestCardServiceACMS.logger = logger;
	}
